...
const INITIAL_PROJECTS = [
  {
    id: "p1",
    name: "Quadro de Gestão Isoflex Gerdau",
    code: "PRJ-2026-001",
    client: "Metalúrgica Gerdau",
    progress: 75.00,
    status: "producao",
    drawings_url: "https://isoflex.com.br/desenhos/PRJ-2026-001.pdf",
  ...
  {
    id: "p2",
    name: "Painéis de Avisos Klabin",
    code: "PRJ-2026-002",
    client: "Indústria Klabin",
    progress: 30.00,
    status: "detalhamento",
    drawings_url: "https://isoflex.com.br/desenhos/PRJ-2026-002.pdf",
    pcp_status: "programado",
    start_date: "2026-06-10",
    delivery_date: "2026-07-05",
  },
  {
    id: "p3",
    name: "Sinalizadores de Solo DHL",
    code: "PRJ-2026-003",
    client: "Logística DHL",
    progress: 100.00,
    status: "concluido",
    drawings_url: "https://isoflex.com.br/desenhos/PRJ-2026-003.pdf",
    pcp_status: "concluido",
    start_date: "2026-05-15",
    delivery_date: "2026-06-10",
  },
  {
    id: "p4",
    name: "Quadros Metas Todeschini",
    code: "PRJ-2026-004",
    client: "Móveis Todeschini",
    progress: 10.00,
    status: "planejamento",
    drawings_url: "",
  ...
  const { data: projects = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        localStorage.setItem("eng_projects_fallback", JSON.stringify(INITIAL_PROJECTS));
  ...
  const addProjMutation = useMutation({
    mutationFn: async (payload: any) => {
      try {
        ...
        const stored = localStorage.getItem("eng_projects_fallback");
        const list = stored ? JSON.parse(stored) : [...INITIAL_PROJECTS];
        list.push({
          id: `p_${Date.now()}`,
          name: payload.name,
          code: payload.code,
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Acompanhamento de desenhos técnicos, cronograma de fabricação e priorização PCP.
            </p>
          </div>
        </div>
